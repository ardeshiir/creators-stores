...
import { deactivateUserByID, getAllUsers } from '@/lib/services/users'
    ...
    <div className=" flex w-full flex-col gap-4 rounded-[14px] border border-[#e4e4e4] px-6 py-4 sm:w-[450px]">
      <div className="flex w-full items-center justify-between">
        <div className="flex flex-col">
          <span className="text-[18px] font-bold">{user.name + ' ' + user.family}</span>
        </div>
      ...
      <div className="flex items-center justify-between">
        <Button
          ...
          className="w-[150px] rounded-[10px] border border-black bg-white text-black hover:bg-white"
        >
          ویرایش اطلاعات
        </Button>
        <Button
          ...
          className="w-[150px] rounded-[10px] border border-[#E23838] bg-white text-[#E23838] hover:bg-white"
        >
          لغو دسترسی
        </Button>
      </div>
