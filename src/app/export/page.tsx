    ...
    <Suspense>
      <div className="container relative mx-auto flex !h-full flex-col px-[24px] md:h-auto md:px-[56px] lg:px-[80px]">
        ...
        <div className="my-[75px] flex w-full flex-wrap-reverse items-center justify-center gap-4 md:my-0">
          <div className="fixed inset-x-0 bottom-0 flex w-full flex-col items-center  justify-center gap-4 bg-[linear-gradient(180deg,rgba(255,255,255,0)_0%,rgba(255,255,255,1)_25%)] px-6 py-[35px] md:static md:flex-row md:pb-[75px] md:pt-[24px]">
            <Button
              asChild
              variant="brand"
