                    ...
                    <FormItem>
                        ...
                        <FormControl>
                            <Input startIcon={<span className={'text-lg text-[#babcbe]'}>متر</span>}
                                   placeholder={'مساحت فروشگاه'} type="number" {...field}
            ...
            <FormField
                ...
                render={({field}) => (
                    <FormItem>
                        ...
                        <FormControl>
                            <Input startIcon={<span className={'text-lg text-[#babcbe]'}>سال</span>}
                                   placeholder={'سابقه فعالیت فروشگاه'} type="number" {...field}
                                   onChange={(e) => field.onChange(+e.target.value)}/>
                        </FormControl>
                        <FormMessage/>
                    </FormItem>
            ...
            <FormField
                ...
                render={({field}) => (
                    <FormItem>
                        ...
                        <FormControl>
                            <Input startIcon={<span className={'text-lg text-[#babcbe]'}>سال</span>}
                                   placeholder={'سابقه همکاری با بنیان‌تحریر'} type="number" {...field}
                                   onChange={(e) => field.onChange(+e.target.value)}/>
                        </FormControl>
                        <FormMessage/>
                    </FormItem>
